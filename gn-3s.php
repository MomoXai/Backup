...
<head>
    ...
    <title>3S FIGHTER [ <?= $_SERVER['SERVER_NAME']; ?> ]</title>
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-brands fa-github"></i>&nbsp;3S Fighter</li>
            <li class="logo-gecko"><img width="400" height="400" src="//i.ibb.co/0rG8zcb/The-Trio-Fighter-Favicon.png" align="right"></li>
    ...
    <div class="menu-tools">
        <ul>
            ...
            <li><a href="//#" class="btn-submit"><i class="fa-solid fa-link"></i>&nbsp;README</a></li>
        </ul>
    </div>
